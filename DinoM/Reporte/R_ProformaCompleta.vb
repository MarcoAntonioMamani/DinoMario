...
Public Class R_ProformaCompleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_ProformaCompleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ProformaCompleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ProformaCompleta = New R_ProformaCompleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
